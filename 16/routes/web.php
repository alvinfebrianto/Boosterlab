...
Route::get('/{anak}/detail/hasil', [App\Http\Controllers\DetailAnakController::class, 'hasil'])->name('detail.hasil');
Route::post('/{anak}/detail/', [App\Http\Controllers\DetailAnakController::class, 'store'])->name('detail.store');
Route::get('/detail/{{ $detail->id}}/edit', [App\Http\Controllers\DetailAnakController::class, 'edit'])->name('detail.edit');
Route::put('/{anak}/detail/', [App\Http\Controllers\DetailAnakController::class, 'update'])->name('detail.update');
