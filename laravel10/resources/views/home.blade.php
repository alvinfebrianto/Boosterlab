            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-10">
                    <div class="card border-0 shadow custom-card">
                        <div class="card-body">
                            <a href="{{ route('anak.create') }}" class="btn btn-md btn-success mb-3">Tambah Anak</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form onsubmit="return confirm('Apakah Anda Yakin?');" action="{{ route('anak.destroy', $anak->nomor) }}" method="POST">
                                                        <a href="{{ route('anak.show', $anak->nomor) }}" class="btn btn-sm btn-dark">Tampilkan</a>
                                                        <a href="{{ route('anak.edit', $anak->nomor) }}" class="btn btn-sm btn-primary">Edit</a>
                                                        @csrf
                                                        @method('DELETE')
