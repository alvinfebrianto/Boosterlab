...
Route::get('/detail/create', [App\Http\Controllers\DetailAnakController::class, 'create'])->name('detail.create');
...
Route::get('/{anak}', [App\Http\Controllers\DetailAnakController::class, 'index'])->name('detail.index');
