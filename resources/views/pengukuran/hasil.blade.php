                    ...
                    <div class="card shadow custom-card">
                        <div class="card-body">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item" style="font-size: 16px;">Berat: {{ $pengukuran0->berat ?? 0 }} Kg</li>
                                <li class="list-group-item" style="font-size: 16px;">Tinggi: {{ $pengukuran0->tinggi ?? 0 }} Cm</li>
                            </ul>
